...
def change_questions(count):
    for i in range(10001):
        ...
        yield Question.objects.all().get(id=10001 * count + i + 1).tags.add(Tag.objects.get(id=i + 1))
...
def create_questions():
    ...
    for i in range(0, 100000, 10001):
        Question.objects.bulk_update(change_questions(i // 10001), ['tags'])
